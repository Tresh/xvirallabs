    ...
    <div className="flex-1 flex flex-col min-w-0 h-screen max-h-screen overflow-hidden bg-background relative">
      ...
      {showScrollBtn && !isEmpty && !composerExpanded && (
        <button
          ...
          className="absolute left-1/2 -translate-x-1/2 z-30 h-9 px-3.5 rounded-full bg-primary text-primary-foreground shadow-xl flex items-center gap-1.5 text-[11px] font-medium hover:bg-primary/90 transition-all border border-primary-foreground/10"
